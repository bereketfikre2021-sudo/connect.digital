    ...
    fetch(contactForm.action, {
      ...
      .then(async (response) => {
        ...
        if (response.ok) {
          ...
          const errorMsg = (data.errors && data.errors.length && data.errors[0].message) || 'Sorry, there was an error sending your message. Please try again or contact us directly at digitalsconnect@gmail.com';
